...
(() => {
    ...
    for (const topNode of def.nodes) {
      ...
      if (topNode.depthAnchor) {
        ...
        faces.forEach((face, fi) => {
          ...
          lcy /= verts.length;
          lcz /= verts.length;
          allFaces.push({ face, key: lcx * cApS + lcy * cAmS + lcz + fi * 1e-9 });
        });
        allFaces.sort((a, b) => a.key - b.key);
        for (let si = 0; si < allFaces.length; si++) {
          renderer.add({ id: def.id, faces: [allFaces[si].face] }, { ...instanceProps, depth: baseDepth + si * 1e-7 });
        }
      }
      if (drawCtx) {
  ...
  var spinner_default = {
    ...
    nodes: [
      ...
      },
      {
        ...
        faces: [],
        lights: [
          { x: -0.35, y: -0.18, z: 0.83, color: "#ff1122", colorOff: "#330005", blink: true, radius: 2.2, blinkHz: 5, phase: 0 },
          { x: -0.35, y: 0.18, z: 0.83, color: "#0066ff", colorOff: "#000d33", blink: true, radius: 2.2, blinkHz: 3, phase: 0.5 }
        ]
      }
    ]
  };
  ...
  var HELI_TYPES = [
    {
      ...
      canCarryCargo: false,
      selectLabel: "DOLPHIN",
      selectSub: { de: "Wendig / Schnell", en: "Agile / Fast", fr: "Agile / Rapide", es: "\xC1gil / R\xE1pido", pt: "\xC1gil / R\xE1pido" },
      selectCap: { de: "Kap.: 3 (Leichtgewicht)", en: "Cap.: 3 (Lightweight)", fr: "Cap. : 3 (L\xE9g\xE8ret\xE9)", es: "Cap.: 3 (Peso ligero)", pt: "Cap.: 3 (Leve)" },
      description: {
        ...
        fr: "Un h\xE9licopt\xE8re de garde-c\xF4tes agile \u2014 id\xE9al pour les interventions rapides en terrain difficile. L\xE9ger, pr\xE9cis, r\xE9actif. L'outil pr\xE9f\xE9r\xE9 des pilotes exp\xE9riment\xE9s.",
        es: "Un helic\xF3ptero de guardacostas \xE1gil \u2014 ideal para despliegues r\xE1pidos en terreno dif\xEDcil. Ligero, preciso, reactivo. La herramienta preferida de los pilotos experimentados.",
        pt: "Um helic\xF3ptero \xE1gil da guarda costeira \u2014 ideal para miss\xF5es r\xE1pidas em terreno dif\xEDcil. Leve, preciso, responsivo. A ferramenta preferida dos pilotos experientes."
      },
      minRankIndex: 1,
    ...
    },
    {
      ...
      selectSub: { de: "Schwer / Stabil", en: "Heavy / Stable", fr: "Lourd / Stable", es: "Pesado / Estable", pt: "Pesado / Est\xE1vel" },
      ...
      description: {
        ...
        fr: "Le cheval de bataille du sauvetage maritime. Transporte de lourdes charges sur de longues distances, m\xEAme par mauvais temps. Une fois lanc\xE9, rien ne l'arr\xEAte.",
        es: "El caballo de batalla del rescate mar\xEDtimo. Transporta cargas pesadas a largas distancias, incluso con mal tiempo. Una vez en marcha, es dif\xEDcil de parar.",
        pt: "O cavalo de trabalho do resgate mar\xEDtimo. Transporta cargas pesadas em longas dist\xE2ncias, mesmo com mau tempo. Uma vez em movimento, \xE9 dif\xEDcil de parar."
      },
      minRankIndex: 0,
      soundProfile: "rotor",
      bladeCount: 4,
    ...
    },
    {
      ...
      canCarryCargo: true,
      selectLabel: "Atlas",
      selectSub: { de: "Tandem / Extraschwer", en: "Tandem / Extra-heavy", fr: "Tandem / Extra-lourd", es: "T\xE1ndem / Superpesado", pt: "T\xE2ndem / Extra-pesado" },
      ...
      description: {
        ...
        fr: "Deux rotors, pas d'excuses. L'Atlas est con\xE7u pour les op\xE9rations massives \u2014 quand les h\xE9licopt\xE8res ordinaires abandonnent, l'Atlas continue de voler.",
        es: "Dos rotores, sin excusas. El Atlas est\xE1 construido para operaciones masivas \u2014 cuando los helic\xF3pteros ordinarios se rinden, el Atlas sigue volando.",
        pt: "Dois rotores, sem desculpas. O Atlas foi constru\xEDdo para opera\xE7\xF5es em massa \u2014 quando os helic\xF3pteros comuns desistem, o Atlas continua voando."
      },
      minRankIndex: 2,
      typeRatingRequired: true,
      soundProfile: "rotor",
    ...
    },
    {
      ...
      selectCap: { de: "Kap.: 3 (Hybrid)", en: "Cap.: 3 (Hybrid)", fr: "Cap. : 3 (Hybride)", es: "Cap.: 3 (H\xEDbrido)", pt: "Cap.: 3 (H\xEDbrido)" },
      description: {
        ...
        pt: "Este spinner policial prestou bons servi\xE7os a Deckhard e McCoy."
      },
      minRankIndex: 3,
      hideWhenLocked: true,
      soundProfile: "rotor",
    ...
    },
    {
      ...
      selectSub: { de: "Schl\xE4ger / Wendig", en: "Flapper / Agile", fr: "Batteur / Agile", es: "Batidor / \xC1gil", pt: "Batedor / \xC1gil" },
      selectCap: { de: "Kap.: 2 (Schnelleinsatz)", en: "Cap.: 2 (Quick deploy)", fr: "Cap. : 2 (D\xE9ploiement rapide)", es: "Cap.: 2 (Despliegue r\xE1pido)", pt: "Cap.: 2 (Implanta\xE7\xE3o r\xE1pida)" },
      description: {
        ...
        fr: "Un ornithopt\xE8re de nouvelle g\xE9n\xE9ration. Deux membres d'\xE9quipage, agilit\xE9 maximale. \xC9tonnamment rapide avec du fret \u2014 ni h\xE9licopt\xE8re, ni avion, quelque chose entre les deux.",
        es: "Un ornit\xF3ptero de nueva generaci\xF3n. Dos tripulantes, agilidad m\xE1xima. Sorprendentemente r\xE1pido con carga \u2014 ni helic\xF3ptero, ni avi\xF3n, algo entre los dos.",
        pt: "Um ornit\xF3ptero de nova gera\xE7\xE3o. Dois tripulantes, agilidade m\xE1xima. Surpreendentemente r\xE1pido com carga \u2014 nem helic\xF3ptero, nem avi\xE3o, algo entre os dois."
      },
      minRankIndex: 3,
      typeRatingRequired: true,
      hideWhenLocked: true,
  ...
  var _defCache = /* @__PURE__ */ new Map();
  var _pending = /* @__PURE__ */ new Set();
  var _onRequestDef = null;
  var setDefRequestCallback = (fn) => {
    _onRequestDef = fn;
  };
  var _getDefEntry = (name) => {
  ...
  var drawMap = () => {
      ...
      if (obj.type === "pad") {
        ...
        if (isSel && panelMap[obj.type]) {
          ...
          if (obj.type === "xmas_house_a" || obj.type === "xmas_house_b" || obj.type === "xmas_house_c") {
            ...
            const colorSel = document.getElementById("m_xmas_house_color");
    ...
    payloads.forEach((p, idx) => {
      ...
      if ((effX === void 0 || isNaN(effX)) && pAny.attachTo?.objectType) {
        const ref = m.objects.find((o) => o.type === pAny.attachTo.objectType);
        if (ref) {
          effX = ref.x + (pAny.attachTo.localX ?? 0);
          effY = ref.y + (pAny.attachTo.localY ?? 0);
        }
      }
      if (effX === void 0 || isNaN(effX)) return;
  ...
  var receiveDefData = (name, data, v2) => {
  ...
  // ../src/shared/utils.ts
  var FOLIAGE_ENCODE = { pine: "p", oak: "o", bush: "b", dead: "d", beach_umbrella: "u", beach_lounger: "l", beach_cooler: "c", beach_umbrella_tilted: "v", beach_person: "g", swimmer: "s", xmas_elf: "x" };
  var FOLIAGE_DECODE = { p: "pine", o: "oak", b: "bush", d: "dead", u: "beach_umbrella", l: "beach_lounger", c: "beach_cooler", v: "beach_umbrella_tilted", g: "beach_person", s: "swimmer", x: "xmas_elf" };
  ...
  var initUI = () => {
    ...
    const showPayloadPopup = (idx, cx, cy) => {
      ...
      if (m.objects.some((o) => ["boat", "pilot_boat", "sar_boat", "salvage_tug", "supply_vessel", "frigate"].includes(o.type)))
        opts.push(["boat", "Boot"]);
      if (m.objects.some((o) => o.type === "messe_halle")) opts.push(["messe_halle", "Messehalle"]);
      ...
      if (pa.type === "person") {
        ...
        const attachOpts = [];
        if (m.objects.some((o) => o.type === "dom")) attachOpts.push({ type: "dom", label: "\u26EA Dom-Dach" });
        if (attachOpts.length > 0) {
          ...
          attachOpts.forEach(({ type, label }) => {
            ...
            cb.onchange = () => {
              if (cb.checked) {
                const ref = m.objects.find((o) => o.type === type);
                const lx = pa.x !== void 0 ? pa.x - (ref?.x ?? 0) : 0;
                const ly = pa.y !== void 0 ? pa.y - (ref?.y ?? 0) : 0;
    ...
    document.getElementById("m_xmas_house_color")?.addEventListener("change", () => {
      ...
      const v = document.getElementById("m_xmas_house_color").value;
      if (v === "") delete obj.colorVariant;
      else obj.colorVariant = v;
      drawMap();
      broadcastPreview();
    ...
    const _placeItem = (type, gx, gy) => {
      ...
      switch (type) {
        ...
        case "volleyball_court":
          ...
          break;
        case "dom":
          m.objects.push({ type: "dom", x: gx, y: gy });
          break;
        case "messe_halle":
          m.objects.push({ type: "messe_halle", x: gx, y: gy });
          break;
      }
      renderObjectList();
      drawMap();
    ...
    if (ctxMenu) {
      const _CTX_GROUPS = [
        { cat: "Stat.", emoji: "\u{1F3D7}", items: [
          ...
          { v: "ring", l: "\u2B55 Ring" },
          { v: "dom", l: "\u26EA K\xF6lner Dom" },
          { v: "messe_halle", l: "\u{1F3DB} Messehalle" }
        ] },
    ...
    const payloadXY = (p, m) => {
      if (p.x !== void 0 && !isNaN(p.x)) return { x: p.x, y: p.y };
      if (p.attachTo?.objectType) {
        const ref = m.objects.find((o) => o.type === p.attachTo.objectType);
      ...
      if (state.moveMode) {
        if (state.selectedObjectIdx !== null) {
          ...
          if (p.attachTo?.objectType) {
            const ref = m.objects.find((o) => o.type === p.attachTo.objectType);
            if (ref) {
              p.attachTo.localX = Math.floor(gx) - ref.x;
              p.attachTo.localY = Math.floor(gy) - ref.y;
            }
          } else {
        ...
        if (state.dragHasMoved) {
          ...
          if (state.dragItemType === "payload") {
            ...
            if (p.attachTo?.objectType) {
              const ref = m.objects.find((o) => o.type === p.attachTo.objectType);
              if (ref) {
                p.attachTo.localX = p.x - ref.x;
                p.attachTo.localY = p.y - ref.y;
              }
              delete p.x;
              delete p.y;
            } else {
  ...
  window.addEventListener("message", (e) => {
    ...
    } else if (e.data.type === "zdefData" && e.data.name !== void 0) {
