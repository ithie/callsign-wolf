...
const _DE = {
    ...
    TUT_LAND_D: 'LANDEN — MOTOR MIT [S] DROSSELN',
    TUT_LAND_M: 'LANDEN — LINKEN STICK NACH UNTEN',
...
const _EN = {
    ...
    TUT_LAND_D: 'LAND — REDUCE THROTTLE WITH [S]',
    TUT_LAND_M: 'LAND — PUSH LEFT STICK DOWN',
