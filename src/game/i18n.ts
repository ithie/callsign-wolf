...
const _DE = {
    ...
    PAYWALL_SUCCESS: 'VOLLVERSION AKTIV!',
    PAYWALL_ERROR: 'FEHLER BEIM KAUF',
    IAP_RESTORE: 'KÄUFE WIEDERHERSTELLEN',
...
const _EN = {
    ...
    PAYWALL_SUCCESS: 'FULL VERSION ACTIVE!',
    PAYWALL_ERROR: 'PURCHASE FAILED',
...
const _ES = {
    ...
    PAYWALL_SUCCESS: '¡VERSIÓN COMPLETA ACTIVA!',
    PAYWALL_ERROR: 'ERROR EN LA COMPRA',
...
const _PT = {
    ...
    PAYWALL_SUCCESS: 'VERSÃO COMPLETA ATIVA!',
    PAYWALL_ERROR: 'ERRO NA COMPRA',
    IAP_RESTORE: 'RESTAURAR COMPRAS',
