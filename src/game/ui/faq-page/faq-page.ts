...
const FAQ_DE = [
    ...
    { q: 'WAS SCHALTET DER KAUF FREI?', a: 'Die kostenlose Version enthält Tutorial und eine Einstiegsmission. Mit einem einmaligen Kauf schaltest du alle Kampagnenmissionen dauerhaft frei – kein Abo, keine weiteren Kosten.' },
...
const FAQ_EN = [
    ...
    { q: 'WHAT DOES THE PURCHASE UNLOCK?', a: 'The free version includes the tutorial and one introductory mission. A one-time purchase unlocks all campaign missions permanently – no subscription, no further costs.' },
