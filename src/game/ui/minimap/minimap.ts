...
export const updateMinimap = (data: MinimapData): void => {
    ...
    _el.style.right = 'max(16px, env(safe-area-inset-right))';
    _el.style.top = 'max(12px, env(safe-area-inset-top))';
    _el.style.bottom = '';
